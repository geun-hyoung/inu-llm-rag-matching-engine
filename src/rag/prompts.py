...
1. target (연구 대상)
   - 정의: 연구/개발의 결과물 또는 대상이 되는 실체
   - 판단: "이 연구는 무엇을 만들거나 다루는가?"에 대한 답
...
2. problem (문제)
   - 정의: 이 연구가 해결하려는 기존의 한계나 부정적 상황
   - 판단: 대조 표현("기존", "however", "but", "기존 방식은")과 함께 나오는 부정적 서술
...
4. objective (목표/효과)
   - 정의: 이 연구가 "달성했다"고 주장하는 결과
   - 판단: "무엇을 달성/실현/개선했는가?"에 대한 답
