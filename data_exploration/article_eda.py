...
def visualize_abstract_distribution(data: List[Dict], output_dir: Path):
    ...
    plt.tight_layout()
    output_path = output_dir / "article_text_length_distribution.png"
...
def main():
    ...
    if original_count != filtered_count:
        print(f"[전처리] 2014년 데이터 제거: {original_count - filtered_count}개 제거됨 (전체: {original_count}개 → 필터링 후: {filtered_count}개)")
